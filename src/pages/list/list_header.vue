<template>
	<div class="list_header">
		...
		<div class="list_category" @click="chooseCategory">
			{{currenSelect.text}}<i class="fa fa-angle-down"></i>
		</div>
		<div class="category_box" :class="{slide_down:isShow}">
			<ul>
				<li v-for="(item,index) in categorys" :data-id="index" v-on:click="onSelect($event)" v-bind:class="[index==currenSelect.id?'active':'']">
					{{item.text}}
				</li>
			</ul>
		</div>
